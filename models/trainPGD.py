...
class myLightningModule(LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        output= multiGPU_CLIP( self.model, prompted_images, text, prompt_token)
        output_ori= multiGPU_CLIP( self.model_ori, prompted_images, text, prompt_token)
        output_clean = multiGPU_CLIP( self.model, prompted_clean_images, text, prompt_token)
    ...
    def validation_step(self, batch, batch_idx):
        ...
        output_prompt= multiGPU_CLIP(self.model, self.prompter(images), text,prompt_token)
        ...
        if self.args.CW:
            ...
            def model_fn(x):
                output_a = multiGPU_CLIP(self.model, self.prompter(clip_img_preprocessing(x)),text,prompt_token)
